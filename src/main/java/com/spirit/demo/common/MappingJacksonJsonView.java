package com.spirit.demo.common;
 ...
 * @since 3.0
 *
 * Re-edit by Knight on 2016-08-04 14:46:19.
 */
public class MappingJacksonJsonView extends AbstractView {
    ...
    protected void writeContent(OutputStream stream, Object value, String jsonPrefix) throws IOException {
        ...
        Object resob=new Object();
        Resp resp = new Resp();
        resp.setData(value);
        resp.setError_code(000);
        resp.setError_msg("Just a test!");
        resob = resp;
        this.objectMapper.writeValue(generator, resob);
//        if (AbnormalResponse.class.isInstance(value)) {
//            AbnormalResponse abnormal = (AbnormalResponse) value;
//            resp.setError_code(abnormal.getCode());
//            resp.setError_msg(abnormal.getMsg());
//            resp.setData(new HashMap());
//            resob=resp;
//            this.objectMapper.writeValue(generator, resob);
//        } else{
//            resp.setError_code(Constants.OK_CODE);
//            resp.setError_msg(Constants.OK_MSG);
//            resp.setData(value);
//            resob=resp;
//            this.objectMapper.writeValue(generator, resob);
//        }
